...
const EthereumChartWidget = () => {
  ...
  const { data: chartData, isLoading, isError, error, refetch } = useCryptoOHLC('ethereum', timeframe);
  ...
  return (
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-xl font-semibold">Ethereum (ETH) - Candlestick Chart</CardTitle>
